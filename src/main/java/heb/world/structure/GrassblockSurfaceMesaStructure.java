...
public class GrassblockSurfaceMesaStructure {
	...
	private static class FeatureRegisterHandler {
		...
		public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 400000) {
						...
						for (int a = 0; a < count; a++) {
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("heb", "badlands1x1_grass"));
							if (template == null)
								return false;
			...
			event.getRegistry().register(feature.setRegistryName("grassblock_surface_mesa"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("heb:grassblock_surface_mesa"), configuredFeature);
		}
	}
