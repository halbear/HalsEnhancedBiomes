...
public class Surface1x1block7Structure {
	...
	private static class FeatureRegisterHandler {
		...
		public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 1000000) {
						...
						for (int a = 0; a < count; a++) {
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("heb", "swamp1x1_ferns2"));
							if (template == null)
								return false;
			...
			event.getRegistry().register(feature.setRegistryName("surface_1x_1block_7"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("heb:surface_1x_1block_7"), configuredFeature);
		}
	}
