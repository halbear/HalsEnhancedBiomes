...
public class TallBirchSurface12Structure {
	...
	private static class FeatureRegisterHandler {
		...
		public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 400000) {
						...
						for (int a = 0; a < count; a++) {
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("heb", "tallbirch3x3x9_tfallenbush"));
							if (template == null)
								return false;
			...
			event.getRegistry().register(feature.setRegistryName("tall_birch_surface_12"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("heb:tall_birch_surface_12"), configuredFeature);
		}
	}
