...
public class SavannaBoulder4Structure {
	...
	private static class FeatureRegisterHandler {
		...
		public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 100000) {
						...
						for (int a = 0; a < count; a++) {
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("heb", "savanna_1x2_smallrockhehe2"));
							if (template == null)
								return false;
			...
			event.getRegistry().register(feature.setRegistryName("savanna_boulder_4"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("heb:savanna_boulder_4"), configuredFeature);
		}
	}
