...
public class StoneSurfaceMesa2Structure {
	...
	private static class FeatureRegisterHandler {
		...
		public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 200000) {
						...
						for (int a = 0; a < count; a++) {
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("heb", "badlands-1x-1_rock2"));
							if (template == null)
								return false;
			...
			event.getRegistry().register(feature.setRegistryName("stone_surface_mesa_2"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("heb:stone_surface_mesa_2"), configuredFeature);
		}
	}
