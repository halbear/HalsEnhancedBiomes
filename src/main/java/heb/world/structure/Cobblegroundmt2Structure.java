...
public class Cobblegroundmt2Structure {
	...
	private static class FeatureRegisterHandler {
		...
		public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 1000000) {
						...
						for (int a = 0; a < count; a++) {
							...
							if (blockAt.getBlock() == Blocks.GRASS_BLOCK)
								blockCriteria = true;
							if (blockAt.getBlock() == Blocks.SNOW)
								blockCriteria = true;
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("heb", "mountains1x1_rock2"));
							if (template == null)
								return false;
			...
			event.getRegistry().register(feature.setRegistryName("cobblegroundmt_2"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("heb:cobblegroundmt_2"), configuredFeature);
		}
	}
