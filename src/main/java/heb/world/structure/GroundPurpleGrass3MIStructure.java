...
public class GroundPurpleGrass3MIStructure {
	...
	private static class FeatureRegisterHandler {
		...
		public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("ground_purple_grass_3_mi"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("heb:ground_purple_grass_3_mi"), configuredFeature);
		}
	}
