...
public class AbandonedTrainSurfaceMesa2Structure {
	...
	private static class FeatureRegisterHandler {
		...
		public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 15000) {
						...
						for (int a = 0; a < count; a++) {
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("heb", "badlands3x4x8abandonedtraindamage"));
							if (template == null)
								return false;
			...
			event.getRegistry().register(feature.setRegistryName("abandoned_train_surface_mesa_2"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("heb:abandoned_train_surface_mesa_2"), configuredFeature);
		}
	}
