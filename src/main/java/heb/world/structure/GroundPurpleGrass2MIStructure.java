...
public class GroundPurpleGrass2MIStructure {
	...
	private static class FeatureRegisterHandler {
		...
		public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 1000000) {
						...
						for (int a = 0; a < count; a++) {
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("heb", "mushroomislands_1x1_grass2"));
							if (template == null)
								return false;
			...
			event.getRegistry().register(feature.setRegistryName("ground_purple_grass_2_mi"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("heb:ground_purple_grass_2_mi"), configuredFeature);
		}
	}
