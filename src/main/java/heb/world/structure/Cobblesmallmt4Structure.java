...
public class Cobblesmallmt4Structure {
	...
	private static class FeatureRegisterHandler {
		...
		public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 300000) {
						...
						for (int a = 0; a < count; a++) {
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("heb", "mountains1x1_rocksnow"));
							if (template == null)
								return false;
			...
			event.getRegistry().register(feature.setRegistryName("cobblesmallmt_4"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("heb:cobblesmallmt_4"), configuredFeature);
		}
	}
