...
public class DirtSurfaceMesaStructure {
	...
	private static class FeatureRegisterHandler {
		...
		public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 200000) {
						...
						for (int a = 0; a < count; a++) {
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("heb", "badlands1x1_dirt"));
							if (template == null)
								return false;
			...
			event.getRegistry().register(feature.setRegistryName("dirt_surface_mesa"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("heb:dirt_surface_mesa"), configuredFeature);
		}
	}
