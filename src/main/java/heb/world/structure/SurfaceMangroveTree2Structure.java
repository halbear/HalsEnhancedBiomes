...
public class SurfaceMangroveTree2Structure {
	...
	private static class FeatureRegisterHandler {
		...
		public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 500000) {
						...
						for (int a = 0; a < count; a++) {
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("heb", "swamp15x19_mangrovetree2"));
							if (template == null)
								return false;
			...
			event.getRegistry().register(feature.setRegistryName("surface_mangrove_tree_2"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("heb:surface_mangrove_tree_2"), configuredFeature);
		}
	}
