...
public class BadlandsSmallTreeForestStructure {
	...
	private static class FeatureRegisterHandler {
		...
		public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 300000) {
						...
						for (int a = 0; a < count; a++) {
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("heb", "badlands5x9_smalltree"));
							if (template == null)
								return false;
			...
			event.getRegistry().register(feature.setRegistryName("badlands_small_tree_forest"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("heb:badlands_small_tree_forest"), configuredFeature);
		}
	}
