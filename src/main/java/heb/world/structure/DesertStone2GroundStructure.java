...
public class DesertStone2GroundStructure {
	...
	private static class FeatureRegisterHandler {
		...
		public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 300000) {
						...
						for (int a = 0; a < count; a++) {
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("heb", "desert-1x-1_rocksmall"));
							if (template == null)
								return false;
			...
			event.getRegistry().register(feature.setRegistryName("desert_stone_2_ground"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("heb:desert_stone_2_ground"), configuredFeature);
		}
	}
