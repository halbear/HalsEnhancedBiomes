...
public class SurfaceTree2MIStructure {
	...
	private static class FeatureRegisterHandler {
		...
		public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 50000) {
						...
						for (int a = 0; a < count; a++) {
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("heb", "mushroomislands5x9_smalltree"));
							if (template == null)
								return false;
			...
			event.getRegistry().register(feature.setRegistryName("surface_tree_2_mi"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("heb:surface_tree_2_mi"), configuredFeature);
		}
	}
