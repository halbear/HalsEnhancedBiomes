...
public class GrassblockSurfaceMesa2Structure {
	...
	private static class FeatureRegisterHandler {
		...
		public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 400000) {
						...
						for (int a = 0; a < count; a++) {
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("heb", "badlands1x1_grass2"));
							if (template == null)
								return false;
			...
			event.getRegistry().register(feature.setRegistryName("grassblock_surface_mesa_2"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("heb:grassblock_surface_mesa_2"), configuredFeature);
		}
	}
