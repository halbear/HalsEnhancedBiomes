...
public class LeavesGroundStructure {
	...
	private static class FeatureRegisterHandler {
		...
		public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 500000) {
						...
						for (int a = 0; a < count; a++) {
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("heb", "plains-1x-1_leaves"));
							if (template == null)
								return false;
			...
			event.getRegistry().register(feature.setRegistryName("leaves_ground"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("heb:leaves_ground"), configuredFeature);
		}
	}
