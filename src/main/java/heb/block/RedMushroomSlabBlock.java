...
import heb.HebModElements;

@HebModElements.ModElement.Tag
public class RedMushroomSlabBlock extends HebModElements.ModElement {
	@ObjectHolder("heb:red_mushroom_slab")
	public static final Block block = null;

	public RedMushroomSlabBlock(HebModElements instance) {
		super(instance, 84);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.EARTH).sound(SoundType.PLANT).hardnessAndResistance(1f, 10f).setLightLevel(s -> 0).harvestLevel(1)
			...
			setRegistryName("red_mushroom_slab");
		}
			...
			switch ((Direction.Axis) state.get(AXIS)) {
				...
				default :
					return VoxelShapes.or(makeCuboidShape(0, 0, 0, 16, 8, 16))
							...
							.withOffset(offset.x, offset.y, offset.z);
				case Z :
					return VoxelShapes.or(makeCuboidShape(0, 0, 16, 16, 16, 8))
