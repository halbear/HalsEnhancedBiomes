...
public class MushroomWallBlock extends HebModElements.ModElement {
	@ObjectHolder("heb:mushroom_wall")
	public static final Block block = null;

	public MushroomWallBlock(HebModElements instance) {
		super(instance, 83);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).hardnessAndResistance(0.2f, 0.1f).setLightLevel(s -> 0)
					.harvestLevel(1).harvestTool(ToolType.HOE).setRequiresTool().notSolid().setOpaque((bs, br, bp) -> false));
			setRegistryName("mushroom_wall");
		}
